...
const BADGES = [
  // === จำนวน Quiz ===
  {
    ...
    description: "ทำ Quiz ครบ 1 ครั้ง",
    category: "quiz",
    check: (user) => user.quizzesCompleted >= 1,
  },
  {
    key: "3_quizzes",
    emoji: "🌱",
  ...
  },
  {
    ...
    description: "ทำ Quiz ครบ 5 ครั้ง",
    category: "quiz",
    check: (user) => user.quizzesCompleted >= 5,
  },
  {
    key: "10_quizzes",
    emoji: "💎",
  ...
  },
  {
    ...
    description: "ทำ Quiz ครบ 20 ครั้ง",
    category: "quiz",
    check: (user) => user.quizzesCompleted >= 20,
  },
  {
    key: "50_quizzes",
    emoji: "🐉",
  ...
  // === Streak ===
  {
    ...
    emoji: "🔥",
    name: "ไฟเริ่มติด",
    description: "Streak 3 วันติด",
    category: "streak",
    check: (user) => user.maxStreak >= 3,
  },
  {
    key: "streak_7",
    emoji: "⚡",
  ...
  // === แชร์ ===
  {
    ...
    emoji: "📢",
    name: "นักแชร์ตัวยง",
    description: "แชร์ผลลัพธ์ครั้งแรก",
    category: "social",
    check: (user) => user.shareCount >= 1,
  },
  {
    key: "share_5",
    emoji: "📣",
    name: "ป่าวประกาศ",
    description: "แชร์ผลลัพธ์ครบ 5 ครั้ง",
    category: "social",
    check: (user) => user.shareCount >= 5,
  },
  ...
  // === พฤติกรรมพิเศษ ===
  {
    ...
    emoji: "⏱️",
    name: "สายเร็วแรง",
    description: "ทำ Quiz เสร็จภายใน 30 วินาที",
    category: "special",
    check: (user) => user.fastestQuizSec !== undefined && user.fastestQuizSec <= 30,
  },
  {
    key: "night_owl",
    emoji: "🦉",
  ...
  // === Coins ===
  {
    ...
    emoji: "💰",
    name: "เศรษฐีเหรียญ",
    description: "สะสม Coins ครบ 500",
    category: "coins",
    check: (user) => user.totalCoinsEarned >= 500,
  },
  {
    key: "coin_2000",
    emoji: "🏦",
    name: "มหาเศรษฐี",
    description: "สะสม Coins ครบ 2,000",
    category: "coins",
    check: (user) => user.totalCoinsEarned >= 2000,
  },
];
